...
const builtinExtensions = {
    ...
    microbitAccelerator: () => require('../extensions/scratch3_microbit__accelerator'),
    microbitBrake: () => require('../extensions/scratch3_microbit__brake'),
    microbitHandle: () => require('../extensions/scratch3_microbit__handle'),
